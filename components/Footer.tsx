    ...
    <footer className="w-full py-8 px-6 md:px-8 border-t border-white/5 bg-[#050505] mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-zinc-500 text-xs md:text-sm font-semibold font-mono tracking-tight">alpacka.ai</span>
          <Code2 className="w-4 h-4 text-zinc-500 hover:text-white cursor-pointer" />
        </div>

        <div className="flex flex-wrap justify-center items-center gap-6 text-[10px] md:text-xs text-zinc-500 font-mono font-semibold tracking-wide">
